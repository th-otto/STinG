...
static void exchange(const char **argv, struct _getopt_data *d)
{
...
static int _getopt_internal_r(int argc, const char **argv, const char *optstring,
...
static int _getopt_internal(int argc, const char **argv, const char *optstring,
				 const struct option *longopts, int *longind, int long_only, int posixly_correct)
{
	int result;
...
{
	return _getopt_internal(argc, argv, optstring, NULL, NULL, 0, 0);
}


int getopt_r(int argc, const char **argv, const char *optstring, struct _getopt_data *d)
{
	return _getopt_internal_r(argc, argv, optstring, NULL, NULL, 0, d, 0);
}
...
int __posix_getopt(int argc, const char **argv, const char *optstring)
{
	return _getopt_internal(argc, argv, optstring, NULL, NULL, 0, 1);
}


int getopt_long(int argc, const char **argv, const char *options, const struct option *long_options, int *opt_index)
{
	return _getopt_internal(argc, argv, options, long_options, opt_index, 0, 0);
}


int getopt_long_r(int argc, const char **argv, const char *options, const struct option *long_options, int *opt_index, struct _getopt_data *d)
{
...
int getopt_long_only(int argc, const char **argv, const char *options, const struct option *long_options, int *opt_index)
{
