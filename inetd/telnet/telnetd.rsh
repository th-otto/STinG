/*
 * GEM resource C output of telnetd
 *
...
static char telnetd_string_0[] = "Terminal";
static char telnetd_string_1[] = "Nothing right now.";


/* mask of MY_ICON */
static _UBYTE telnetd_IMAGE0[] = {
...
/* data of MY_ICON */
static _UBYTE telnetd_IMAGE1[] = {
0x00, 0x00, 0x00, 0x00, 0x03, 0xFF, 0xFF, 0xC0, 0x04, 0x00, 0x00, 0x20, 0x05, 0xFF, 0xFF, 0xA0, 
0x05, 0x00, 0x00, 0xA0, 0x05, 0x75, 0xBC, 0xA0, 0x05, 0x00, 0x00, 0xA0, 0x05, 0x6F, 0x80, 0xA0, 
0x05, 0x00, 0x00, 0xA0, 0x05, 0x7D, 0x60, 0xA0, 0x05, 0x00, 0x00, 0xA0, 0x05, 0x6F, 0x00, 0xA0, 
0x05, 0x00, 0x00, 0xA0, 0x05, 0xFF, 0xFF, 0xA0, 0x04, 0x00, 0x00, 0x20, 0x03, 0xFF, 0xFF, 0xC0, 
0x00, 0x10, 0x08, 0x00, 0x0F, 0xFF, 0xFF, 0xF0, 0x08, 0x00, 0x00, 0x10, 0x08, 0x00, 0x1F, 0xD0, 
0x08, 0x00, 0x00, 0x10, 0x08, 0x00, 0x00, 0x10, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};


ICONBLK rs_iconblk[] = {
	{ CW telnetd_IMAGE0, CW telnetd_IMAGE1, telnetd_string_0, 0x1000,0,0, 8,0,32,24, 0,26,48,8 }
};
...
/* ICON */
	...
	{ 0, -1, -1, G_ICON, OF_LASTOB, OS_NORMAL, C_UNION(&rs_iconblk[0]), 5,257, 12288,8704 }, /* MY_ICON */

/* MAIN */

	{ -1, 1, 1, G_BOX, OF_NONE, OS_OUTLINED, C_UNION(0x21100L), 0,0, 33,8 },
	{ 0, -1, -1, G_STRING, OF_LASTOB, OS_NORMAL, C_UNION(telnetd_string_1), 5,2, 18,1 }
};
...
#ifdef __STDC__
_WORD telnetd_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD telnetd_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD telnetd_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD telnetd_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD telnetd_rsc_free(void)
#else
_WORD telnetd_rsc_free()
#endif
{
#if NUM_OBS != 0
