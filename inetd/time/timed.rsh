/*
 * GEM resource C output of timed
 *
...
static char timed_string_0[] = "Synchronizer";
static char timed_string_1[] = "Nothing right now.";


/* mask of MY_ICON */
static _UBYTE timed_IMAGE0[] = {
...
/* data of MY_ICON */
static _UBYTE timed_IMAGE1[] = {
0x00, 0x03, 0x80, 0x00, 0x00, 0x0C, 0x60, 0x00, 0x00, 0x30, 0x18, 0x00, 0x00, 0xC3, 0x86, 0x00, 
0x03, 0x85, 0x43, 0x80, 0x00, 0xA5, 0x4A, 0x00, 0x00, 0x95, 0xD2, 0x00, 0x00, 0x94, 0x52, 0x00, 
0x00, 0x93, 0x92, 0x00, 0x00, 0x80, 0x02, 0x00, 0x00, 0x7F, 0xFC, 0x00, 0x00, 0x01, 0x00, 0x00, 
0x00, 0x08, 0x20, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x20, 0x00, 0x00, 0x01, 0x00, 0x00, 
0x00, 0x08, 0x20, 0x00, 0x00, 0x01, 0x70, 0x00, 0x00, 0x08, 0x70, 0x00, 0x00, 0x1D, 0x70, 0x00, 
0x00, 0x1F, 0xA0, 0x00, 0x00, 0x1F, 0x80, 0x00, 0x00, 0x0B, 0x80, 0x00, 0x00, 0x01, 0x00, 0x00};


ICONBLK rs_iconblk[] = {
	{ CW timed_IMAGE0, CW timed_IMAGE1, timed_string_0, 0x1000,0,0, 20,0,32,24, 0,26,72,8 }
};
...
/* ICON */
	...
	{ 0, -1, -1, G_ICON, OF_LASTOB, OS_NORMAL, C_UNION(&rs_iconblk[0]), 1795,769, 18432,8704 }, /* MY_ICON */

/* MAIN */

	{ -1, 1, 1, G_BOX, OF_NONE, OS_OUTLINED, C_UNION(0x21100L), 0,0, 33,8 },
	{ 0, -1, -1, G_STRING, OF_LASTOB, OS_NORMAL, C_UNION(timed_string_1), 5,2, 18,1 }
};
...
#ifdef __STDC__
_WORD timed_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD timed_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD timed_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD timed_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD timed_rsc_free(void)
#else
_WORD timed_rsc_free()
#endif
{
#if NUM_OBS != 0
