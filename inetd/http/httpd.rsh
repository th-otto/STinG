/*
 * GEM resource C output of httpd
 *
...
static char httpd_string_0[] = "WorldWideWeb";
static char httpd_string_1[] = "Nothing right now.";


/* mask of MY_ICON */
static _UBYTE httpd_IMAGE0[] = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00};

/* data of MY_ICON */
static _UBYTE httpd_IMAGE1[] = {
0x00, 0x40, 0x10, 0x00, 0x00, 0x40, 0x10, 0x00, 0x00, 0x3F, 0xE0, 0x00, 0x00, 0x60, 0x38, 0x00, 
0x00, 0x90, 0x26, 0x00, 0x01, 0x17, 0xE1, 0x80, 0x02, 0x18, 0x50, 0x60, 0x84, 0x28, 0x4C, 0x11, 
0x78, 0x47, 0xC2, 0x0E, 0x0C, 0x84, 0x61, 0x78, 0x0B, 0x8A, 0x91, 0x88, 0x09, 0x71, 0x8E, 0x88, 
0x09, 0x1D, 0xF8, 0x88, 0x09, 0x13, 0x88, 0x88, 0x09, 0x1F, 0xE8, 0x88, 0x09, 0x71, 0x5C, 0x88, 
0x09, 0x89, 0x43, 0x88, 0x0E, 0x86, 0x26, 0x70, 0x70, 0x43, 0xF8, 0x1C, 0x80, 0x22, 0x10, 0x63, 
0x00, 0x12, 0x11, 0x80, 0x00, 0x0C, 0x0E, 0x00, 0x00, 0x07, 0xF8, 0x00, 0x00, 0x04, 0x04, 0x00};


ICONBLK rs_iconblk[] = {
	{ CW httpd_IMAGE0, CW httpd_IMAGE1, httpd_string_0, 0x1000,0,0, 20,0,32,24, 0,26,72,8 }
};
...
/* ICON */
	...
	{ 0, -1, -1, G_ICON, OF_LASTOB, OS_NORMAL, C_UNION(&rs_iconblk[0]), 1283,769, 18432,8704 }, /* MY_ICON */

/* MAIN */

	{ -1, 1, 1, G_BOX, OF_NONE, OS_OUTLINED, C_UNION(0x21100L), 0,0, 33,8 },
	{ 0, -1, -1, G_STRING, OF_LASTOB, OS_NORMAL, C_UNION(httpd_string_1), 5,2, 18,1 }
};
...
#ifdef __STDC__
_WORD httpd_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD httpd_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD httpd_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD httpd_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD httpd_rsc_free(void)
#else
_WORD httpd_rsc_free()
#endif
{
#if NUM_OBS != 0
