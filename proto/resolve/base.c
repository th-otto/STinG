...
static void build_base(void)
{
	...
	cache[2].alias = NULL;
	cache[2].used = time(NULL);
	cache[2].next = &cache[1];
	...
	cache[3].alias = NULL;
	cache[3].used = time(NULL);
	cache[3].next = &cache[2];
	...
	cache[4].alias = NULL;
	cache[4].used = time(NULL);
	cache[4].next = &cache[3];
	...
	cache[5].alias = NULL;
	cache[5].used = time(NULL);
	cache[5].next = &cache[4];
	...
	cache[6].alias = NULL;
	cache[6].used = time(NULL);
	cache[6].next = &cache[5];
	...
	cache[7].alias = NULL;
	cache[7].used = time(NULL);
	cache[7].next = &cache[6];
	...
	cache[8].alias = NULL;
	cache[8].used = time(NULL);
	cache[8].next = &cache[7];
	...
	cache[9].alias = NULL;
	cache[9].used = time(NULL);
	cache[9].next = &cache[8];
	...
	cache[10].alias = NULL;
	cache[10].used = time(NULL);
	cache[10].next = &cache[9];
	...
	cache[11].alias = NULL;
	cache[11].used = time(NULL);
	cache[11].next = &cache[10];
	...
	cache[12].alias = NULL;
	cache[12].used = time(NULL);
	cache[12].next = &cache[11];
	...
	cache[13].alias = NULL;
	cache[13].used = time(NULL);
	cache[13].next = &cache[12];
	...
	cache[14].alias = NULL;
	cache[14].used = time(NULL);
	cache[14].next = &cache[13];
	...
	cache[15].alias = NULL;
	cache[15].used = time(NULL);
	cache[15].next = &cache[14];
	...
	cache[16].alias = NULL;
	cache[16].used = time(NULL);
	cache[16].next = &cache[15];
	...
	cache[17].alias = NULL;
	cache[17].used = time(NULL);
	cache[17].next = &cache[16];
	...
	cache[18].alias = &dn[0];
	cache[18].used = time(NULL);
	cache[18].next = &cache[17];
	...
	cache[19].alias = &dn[1];
	cache[19].used = time(NULL);
	cache[19].next = &cache[18];
	...
	cache[20].alias = &dn[2];
	cache[20].used = time(NULL);
	cache[20].next = &cache[19];
	...
	cache[21].alias = &dn[3];
	cache[21].used = time(NULL);
	cache[21].next = &cache[20];
	...
	cache[22].alias = &dn[4];
	cache[22].used = time(NULL);
	cache[22].next = &cache[21];
	...
	cache[23].alias = NULL;
	cache[23].used = time(NULL);
	cache[23].next = &cache[22];
	...
	cache[24].alias = NULL;
	cache[24].used = time(NULL);
	cache[24].next = &cache[23];
	...
	cache[25].alias = NULL;
	cache[25].used = time(NULL);
	cache[25].next = &cache[24];
	...
	cache[26].alias = NULL;
	cache[26].used = time(NULL);
	cache[26].next = &cache[25];
	...
	cache[27].alias = &dn[5];
	cache[27].used = time(NULL);
	cache[27].next = &cache[26];
	...
	cache[28].alias = NULL;
	cache[28].used = time(NULL);
	cache[28].next = &cache[27];
	...
	cache[29].alias = &dn[6];
	cache[29].used = time(NULL);
	cache[29].next = &cache[28];
	...
	cache[30].alias = &dn[7];
	cache[30].used = time(NULL);
	cache[30].next = &cache[29];
	...
	cache[31].alias = NULL;
	cache[31].used = time(NULL);
	cache[31].next = &cache[30];
	...
	cache[32].alias = NULL;
	cache[32].used = time(NULL);
	cache[32].next = &cache[31];
	...
	cache[33].alias = NULL;
	cache[33].used = time(NULL);
	cache[33].next = &cache[32];
	...
	cache[34].alias = NULL;
	cache[34].used = time(NULL);
	cache[34].next = &cache[33];
	...
	cache[35].alias = NULL;
	cache[35].used = time(NULL);
	cache[35].next = &cache[34];
	...
	cache[36].alias = NULL;
	cache[36].used = time(NULL);
	cache[36].next = &cache[35];
	...
	cache[37].alias = NULL;
	cache[37].used = time(NULL);
	cache[37].next = &cache[36];
